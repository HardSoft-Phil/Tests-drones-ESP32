...
const int INT_PIN		= 26;	// * INT

// Pins MPU9250 SPI :
const int SCLK_PIN = 18;		// SCL
const int MOSI_PIN = 23;		// SDA
const int MISO_PIN = 19; 	// EDA
...
// Pins radio :
const int SBUS_RX = 22;		// Rx SBUS
const int SBUS_TX = 23;		// Tx SBUS
